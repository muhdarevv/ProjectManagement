...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            ...
            .bg-white{--bg-opacity:1;background-color:#fff;background-color:rgba(245,245,220,var(--bg-opacity))}
            .bg-gray-100{background-color:beige}
        ...
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
                <div class="flex justify-center pt-8 sm:justify-start sm:pt-0">
                   <h1>UNITEN R&D SDN BHD (URND)</h1><br> <br>  
                   
                </div>
                <h3>PROJECT MANAGEMENT SYSTEM</h3>
                <p>by Muhammad Arif Lukman<br>IS0101349</p>
                ...
                <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
                    <div class="text-center text-sm text-gray-500 sm:text-left">
                        <div class="flex items-center">
                            ...
                            CSEB5123 <br> Advanced Web Application Development <br> Sem 1 2021/2022
                            </a>
                    ...
                    <a  class="ml-1 underline"> Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})</a>
                    </div>
                </div>
            </div>
        </div>
